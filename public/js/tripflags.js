/*                             TRIPFLAGS.JS
  File responsible for associating trip codes with trip flag images. To add a
  tripflag, add the flag image to ./public/icons/tripflags, then associate the
  flag file with the desired trip code in the flags_image_table. Additionally
  you can associate hover strings with given tripcodes using the
  flags_hover_strings. Examples can be seen below in the commented lines.
*/
